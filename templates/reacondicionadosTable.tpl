...
{if $cantReacondicionados > 1}
    ...
    <nav aria-label="Paginacion">
        <ul class="pagination">
            ...
            <li class="page-item"> <a class="page-link" href="verReacondicionados/?pagina={$pagina + 1}">Siguiente</a></li>
    </nav>

{/if}
<div id="form-crear-comentario" data-id_usuario="{$id_usuario}"
    data-id_reacondicionado="{$reacondicionado->id_reacondicionado}">
    {if $cantReacondicionados <= 1}
...
<script src="js/coment.js?newversion"></script>
